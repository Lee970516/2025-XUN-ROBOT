...
public class TrackMiddleReef_Neo extends Command {
  /** Creates a new TrackMiddleReef_Neo. */
  ...
  public TrackMiddleReef_Neo(PhotonVisionSubsystem photonVisionSubsystem, SwerveSubsystem_Neo swerveSubsystem, DoubleSupplier xSpeed) {
